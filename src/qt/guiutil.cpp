...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("batjorge"))
        return false;
...
{
    // Convert batjorge:// to batjorge:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("batjorge://"))
    {
        uri.replace(0, 12, "batjorge:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "batjorge.lnk";
}
...
{
    return GetAutostartDir() / "batjorge.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("batjorge-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  batjorge-qt [" + tr("command-line options") + "]                     " + "\n";
...
{
    app.setStyleSheet("QWidget        { background: rgb(41,128,185); }"
                      "QFrame         { border: none; }"
                      ...
                      "QMenuBar       { background: rgb(41,128,185); color: rgb(0,0,0); }"
                      "QMenu          { background: rgb(41,128,185); color: rgb(100,100,100); }"
                      ...
                      "QToolButton    { background: rgb(41,128,185); color: rgb(116,122,134); border: none; border-left-color: rgb(30,32,36); border-left-style: solid; border-left-width: 6px; margin-top: 8px; margin-bottom: 8px; }"
                      ...
                      "QHeaderView::section { background: rgb(41,128,185); color: rgb(255,255,255); }"
                      "QToolBar       { background: rgb(41,128,185); border: none; }");
}
